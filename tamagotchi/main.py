...
def get_args():
    ...
    parser.add_argument('--if_vec_norm', type=float, default=0.0) # whether to normalize the input
    parser.add_argument('--if_train_actor_std', type=float, default=0.0) # whether to train the std of the stochastic policy
